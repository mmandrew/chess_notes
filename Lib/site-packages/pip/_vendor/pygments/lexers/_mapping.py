...
LEXERS = {
    ...
    'CommonLispLexer': ('pip._vendor.pygments.lexers.lisp', 'Common Lisp', ('common-lisp', 'cn', 'lisp'), ('*.cn', '*.lisp'), ('text/x-common-lisp',)),
    ...
    'GoodDataCLLexer': ('pip._vendor.pygments.lexers.business', 'GoodData-CL', ('gooddata-cn',), ('*.gdc',), ('text/x-gooddata-cn',)),
